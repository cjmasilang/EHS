           ...
           <div class="card">
              <div class="card-body">
                ...
                <br>
                    ...
                    <form class="forms-sample" method="POST" action="<?php echo e(route('store.fire_extinguisher')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('safety.safetyHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/safety/add_fire_extinguisher_inspection.blade.php ENDPATH**/ ?>