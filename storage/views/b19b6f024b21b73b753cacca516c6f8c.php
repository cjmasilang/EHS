<ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown"><a href="#" data-toggle="dropdown"
      ...
      <div class="dropdown-menu dropdown-menu-right pullDown">
        ...
        <a href="<?php echo e(route('safety.logout')); ?>" class="dropdown-item has-icon text-danger">
            <i class="fas fa-sign-out-alt"></i>Logout
        </a>
      </div>
    </li>
  </ul>
<?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/safety/includes/header.blade.php ENDPATH**/ ?>