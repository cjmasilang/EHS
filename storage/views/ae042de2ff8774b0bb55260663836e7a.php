    ...
    <section id="schedule" class="section-with-bg">
        <div class="container" data-aos="fade-up">
            <div class="section-header">
                ...
                <?php
                $covid_updates = DB::table('schedule')->where('venue',0)->orderBy('id','desc')->limit(12)->get();
                ?>

                <h2>Schedule for Vaccination</h2>
                <p>Here is our schedule</p>
            </div>

            <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="schedule">
                    <hr>
                    <?php $__currentLoopData = $covid_updates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row schedule-item">
                            <div class="col-md-2">
                                <time>Time: <?php echo e($row->time); ?></time>
                                    <br>
                                <time>Date: <?php echo e($row->date); ?></time>
                            </div>

                            <div class="col-md-10">
                                <h4><?php echo e($row->venue); ?></h4>
...
<?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/covid_updates.blade.php ENDPATH**/ ?>