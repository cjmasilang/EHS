                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                                <div class="card-content">
                                    ...
                                    <h2 class="mb-3 font-18"><?php echo e(count($accident_classification)); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($unsafe_act)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($shift)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($audit_form)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($workplace_inspection_checklist)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($ptw_register)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($fire_extinguisher_inspection)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                ...
                                <h2 class="mb-3 font-18"><?php echo e(count($ehs_policies_manual)); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('safety.safetyHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/safety/dashboard.blade.php ENDPATH**/ ?>