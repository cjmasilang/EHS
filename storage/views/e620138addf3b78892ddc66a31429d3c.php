        ...
        <div class="container" data-aos="fade-up">
            <div class="row gx-0">
                ...
                <div class="content">
                    ...
                    <a href="<?php echo e(URL::to('about')); ?>" class="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
                        <span>Read More</span>
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
                    <img src="<?php echo e(asset('frontend/assets/img/tree.jpg')); ?>" class="img-fluid" alt="">
                </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-box green">
                        ...
                        <a href="<?php echo e(route('healthpage')); ?>" class="read-more"><span>Check More</span> <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                <?php $__currentLoopData = $photosmall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">

                        <div class="portfolio-wrap">
                            <img src="<?php echo e(asset($row->photo)); ?>" class="img-fluid" alt="">
                            <div class="portfolio-info">
                            <h4><?php echo e($row->title); ?></h4>

                            <div class="portfolio-links">
                                <a href="<?php echo e(asset($row->photo)); ?>" data-gallery="portfolioGallery" class="portfokio-lightbox" title="App 1"><i class="bi bi-plus"></i></a>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/welcome.blade.php ENDPATH**/ ?>