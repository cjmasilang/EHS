        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title">
                    <a href="<?php echo e(route('add.dept')); ?>"><button type="button" class="btn btn-success btn-fw" id="department" style="float: center;">Add Department</button></a>
                </h5>
            </div>
                ...
                <table class="table table-striped table-hover" id="save-stage" style="width:99%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('view.dept', $row->id)); ?>" class="btn btn-primary">View</a>
                            <a href="<?php echo e(route('edit.dept', $row->id)); ?>" class="btn btn-success">Edit</a>
                            <a href="<?php echo e(route('delete.dept', $row->id)); ?>" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('admin.adminHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/admin/department.blade.php ENDPATH**/ ?>