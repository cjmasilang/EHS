    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row content">
                ...
                <ul>
                    <li><i class=""></i> DRUG & ALCOHOL POLICY. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                    <li><i class=""></i> ENVIROMENTAL POLICY. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                    <li><i class=""></i> HAZCOM. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                    <li><i class=""></i> HIV-AIDS POLICY. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                    <li><i class=""></i> SAFETY HEALTH POLICY. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                    <li><i class=""></i> UBERCULOSIS POLICY. <a href="<?php echo e(asset('frontend/assets/Policy PDF/DRUG AND ALCOHOL POLICY.pdf')); ?>">Click here</a></li>
                </ul>
...
<?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/policies.blade.php ENDPATH**/ ?>