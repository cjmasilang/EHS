...
<section class="section">
    <div class="pagetitle">
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('news_management')); ?>">Back</a></li>
        ...
        <div class="col-lg-12">
           <div class="card">
              <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="<?php echo e(route('store.news')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="tags_id" name="tags_id">
                                ...
                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->tags); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                          $('select[name="tags_id"]').on('change', function(){
                              ...
                              if(tags_id) {
                                  $.ajax({
                                      url: "<?php echo e(url('/get/subtags/')); ?>/"+tags_id,
                                      type:"GET",
                                      dataType:"json",
                                      success:function(data) {
                                         $("#subtags_id").empty();
...
<?php echo $__env->make('admin.adminHome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VBEHS\resources\views/admin/add_news.blade.php ENDPATH**/ ?>