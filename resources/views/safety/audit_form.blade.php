        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="card-title">
                        <a href="{{ route('add.audit_form') }}"><button type="button" class="btn btn-success btn-fw" id="shift" style="float: center;">Add Audit Checklist</button></a>
                    </h5>
                </div>
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('view.audit_form', $row->id) }}" class="btn btn-primary">View</a>
                                <a href="{{ route('delete.audit_form', $row->id) }}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        @endforeach
